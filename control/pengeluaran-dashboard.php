<?php
     ...
     if($_POST['date'] != '' && $_POST['pengeluaran'] !='' && $_POST['id_kategori_khas'] !='' && $_POST['keterangan'] !=''  ){
         ...
         mysqli_query($con, "insert into arus_khas (kredit, id_subkategori_khas, keterangan, dt, dtime, orders,gerai) values ('$pengeluran','$id_kategori_khas','$keterangan','$dt','$datetime', 'Y','$_POST[gerai]') ");
