...
if(isset($_POST["product_id"]))
{
     ...
     if(!empty($_SESSION["shopping_cart"]))
     {
          ...
          <a href="./?page=penjualan&act=cashier" >
           <div class="box bg-info">
             <span class="font-weight-bold text-white"><i class="ti-wallet"></i> Pay</span>
             <span class="font-weight-bold text-white">Rp. '.number_format($total).'</span>
           </div>
            </a>
         </td>
               <tr>
