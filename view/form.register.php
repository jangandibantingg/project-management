          ...
          <div class="panel panel-info mt10 br-n">
            ...
            <div class="panel-heading heading-border bg-white">
              <div class="section row mn">
                <div class="col-sm-4">
                  <a href="pages_register.html#" class="button btn-social facebook span-left mr5 btn-block">
                    <span>
                      <i class="fa fa-facebook"></i>
                    </span>Facebook</a>
                </div>
                <div class="col-sm-4">
                  <a href="pages_register.html#" class="button btn-social twitter span-left mr5 btn-block">
                    <span>
                      <i class="fa fa-twitter"></i>
                    </span>Twitter</a>
                </div>
                <div class="col-sm-4">
                  <a href="pages_register.html#" class="button btn-social googleplus span-left btn-block">
                    <span>
              ...
              <div class="panel-body p25 bg-light">
                ...
                <div class="section mb15">
                  <label class="option block">
                    ...
                    <a href="pages_register.html#" class="theme-link"> 7-day free PRO trial. </a>
                  </label>
                  <label class="option block mt15">
                    <input type="checkbox" name="terms">
                    <span class="checkbox"></span>I agree to the
                    <a href="pages_register.html#" class="theme-link"> terms of use. </a>
                  </label>
                </div>
